...
function checksCreateTodosUserAvailability(request, response, next) {
  ...
  return response.status(403).json({ erro: "You already here ten todos createad. Please, change your plan"})
}
...
function checksTodoExists(request, response, next) {
  ...
  if(!userTodo) {
    return response.status(404).json({ error : "todo dnon't found"})
  }
